...
#define RED1_GPIO_Port GPIOF
#define YEL3_Pin GPIO_PIN_1
#define YEL3_GPIO_Port GPIOF
#define YEL2_Pin GPIO_PIN_0
#define YEL2_GPIO_Port GPIOA
#define YEL1_Pin GPIO_PIN_1
#define YEL1_GPIO_Port GPIOA
#define GRN3_Pin GPIO_PIN_2
#define GRN3_GPIO_Port GPIOA
#define GRN2_Pin GPIO_PIN_3
#define GRN2_GPIO_Port GPIOA
#define GRN1_Pin GPIO_PIN_4
